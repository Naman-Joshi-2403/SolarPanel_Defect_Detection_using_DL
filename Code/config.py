...
class Config_elements():    
    ...
    ongoing_maintainance_path = os.path.abspath(r'.\Static\ongoing_maintainance.csv')
    maintainance_dump_path = os.path.abspath(r'.\Static\maintainance_dump.csv')